...
Router.post("/Insert", (req, res) => {
  ...
  console.log(Details);
  contact.contact("contact", "Insert", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.delete("/Delete:name", (req, res) => {
  ...
  contact.contact("contact", "Delete", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.put("/Update:name", (req, res) => {
  ...
  console.log(Details);
 contact.contact("contact", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.get("/Read:name", (req, res) => {
  ...
  console.log(Details);
 contact.contact("contact", "Read", Details)
    .then((result) => {
